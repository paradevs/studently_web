...
const ThreadCard = ({
    ...
    console.log (`HERE COMMUNITY  ${community}`)

    return (
        <article className={`flex w-full flex-col rounded-3xl shadow-full-side ${isComment ? " shadow-none px-0 xs:px-7" : "bg-dark-2 p-7"
            }`}>
